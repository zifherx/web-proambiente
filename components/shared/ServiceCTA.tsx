  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blueAmbiente to-blueAmbiente/80 p-8 text-white shadow-lg">
      ...
      <div className="relative z-10">
        <h3 className="mb-4 text-2xl font-bold">¿Necesita un servicio personalizado?</h3>
        <p className="mb-6 max-w-lg text-white/90">
          Contáctenos hoy mismo para una evaluación gratuita y un presupuesto adaptado a sus necesidades específicas.
