...
export function CTA2Section({ service }: ServiceCard) {
  return (
        ...
        <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-r from-blueAmbiente to-blueAmbiente/80 p-8 text-center text-white shadow-xl">
          <FadeInWhenVisible>
            <h2 className="mb-4 text-3xl font-bold">
              ¿Listo para un ambiente más saludable?
            </h2>
            <p className="mx-auto mb-8 max-w-2xl text-lg text-white/90">
              Contáctenos hoy mismo y descubra cómo nuestro servicio de{" "}
              {service.title} puede ayudarle a mantener su hogar o negocio en
              óptimas condiciones.
            </p>
            <Button
              size="lg"
